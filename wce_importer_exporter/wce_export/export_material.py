...
def write_materials_and_sprites(mesh, file, written_sprites=set(), written_materials=set(), written_palettes=set()):
    ...
    def get_node_group_name(node):
        ...
        if "USERDEFINED_8" in node.node_tree.name:
            return "USERDEFINED_8"
    ...
    def write_material_palette(palette_name, materials, file):
    ...
    if palette_name and unique_materials:
        write_material_palette(palette_name, unique_materials, file)
