...
def create_node_group_ud17():
    # Create the node group
    node_group = bpy.data.node_groups.new(name="USERDEFINED_17", type='ShaderNodeTree')
...
def create_material_with_node_group_ud17(material_name, texture_path, node_group):
