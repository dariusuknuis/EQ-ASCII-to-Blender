...
def create_node_group_t5ag1():
    ...
    node_group = bpy.data.node_groups.new(name="TEXTURE5AMBIENTGOURAUD1", type='ShaderNodeTree')
...
def create_material_with_node_group_t5ag1(material_name, texture_path, node_group):
