...
def create_material_with_node_group_ud21(material_name, texture_path, node_group):
    ...
    links.new(image_texture_node.outputs.get('Color'), group_node.inputs.get('sRGB Texture'))
    ...
    links.new(group_node.outputs.get('Shader'), material_output_node.inputs['Surface'])
