...
def create_node_group_ud02():
    # Create the node group
    node_group = bpy.data.node_groups.new(name="USERDEFINED_2", type='ShaderNodeTree')
...
def create_material_with_node_group_ud02(material_name, texture_path, node_group):
