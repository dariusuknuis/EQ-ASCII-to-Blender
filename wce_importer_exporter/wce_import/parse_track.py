...
def parse_track_animation(tag, model_prefix):
...
def parse_track(r, parse_property, model_prefix, current_line):
    track_definitions = {}
    animations = {}
    armature_tracks = {}
    ...
    if is_animation:
        ani_prefix, model_name = parse_track_animation(track_instance_name, model_prefix)
